...
const FASES_CIENCIA = [
    ...
    { 
        ...
        prerequisiteGameId: 'frogger_reciclagem', 
    },
];
// -------------------------------------------------------------------------

export default function FaseCiencia() {
    const { user } = useAuth();
        ...
        <ScreenContainer>
            <View style={pageStyles.container}>
                <View style={pageStyles.titleContainer}>
                    <Text style={pageStyles.titleText}>Unidade 1 - Ciências</Text>
                </View>
